...
public class FroggerButton extends Button {
	...
	private final String BUTTON_PRESSED_STYLE="-fx-background-color: transparent; -fx-background-image: url(/model/resources/green_button05.png)";
	private final String BUTTON_RELEASED_STYLE="-fx-background-color: transparent; -fx-background-image: url(/model/resources/green_button04.png)";
